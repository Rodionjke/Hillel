    ...
    if (Math.max(...Object.values(votesCount)) === 0) {
        ...
        return (
            <div>
                <h3>Переможець</h3>
                {winner === 'googleVotes' &&
                    <img src={googleUrl} alt="google" width='48px' height='48px' className="mt-3 mb-3"/>}
                {winner === 'facetimeVotes' &&
                    <img src={facetimeUrl} alt="facetime" width='48px' height='48px' className="mt-3 mb-3"/>}
                {winner === 'netflixVotes' &&
                    <img src={netflixUrl} alt="netflix" width='48px' height='48px' className="mt-3 mb-3"/>}
                {winner === 'snapchatVotes' &&
                    <img src={snapchatUrl} alt="snapchat" width='48px' height='48px' className="mt-3 mb-3"/>}
                {winner === 'xboxVotes' &&
                    <img src={xboxUrl} alt="xbox" width='48px' height='48px' className="mt-3 mb-3"/>}
